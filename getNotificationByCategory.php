<?php
    ...
    if($conn->connect_error) {
        ...
        $query = "SELECT * FROM `notification_of_work` JOIN category_notification USING(notification_of_work_id) JOIN category USING(category_id) WHERE category_name = '$not_category'";
